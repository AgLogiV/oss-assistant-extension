...
3. **Optional validated remote overlay**
   ...
   - Future commit boundaries for this direction:
     ...
     5. add staging/source selection later. Staging/source selection is useful for cheaper tests, but it is secondary to making the JSON runtime contract explicit and reusable.
