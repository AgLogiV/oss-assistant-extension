...
Прочети ПЪРВО: docs/OSS_ASSISTANT_DECK_HANDOFF.md
Редактирай САМО: tmp/slides/oss-assistant/build/build.mjs
...
Изход: outputs/oss-assistant-deck/output.pptx (fallback: OSS-Assistant-prezentaciya.pptx или output-latest.pptx ако файлът е отворен в PowerPoint)
Прегледи: tmp/slides/oss-assistant/preview/slide-XX.png
...
| Път | Роля |
|-----|------|
| `tmp/slides/oss-assistant/build/build.mjs` | **Единствен източник на истина** — целият deck се генерира от тук |
| `tmp/slides/oss-assistant/build/node_modules/@oai/artifact-tool` | Библиотека за editable `.pptx` (`Presentation`, shapes, charts, export) |
| `tmp/slides/pro-reference-images/slide-01.png` | Hero фон — cover |
| `tmp/slides/pro-reference-images/slide-05.png` | Фон за chart слайд |
| `tmp/slides/pro-reference-images/slide-12.png` | Фон за финално обобщение |
| `tmp/slides/oss-assistant/preview/slide-XX.png` | PNG preview на всеки слайд (генерира се автоматично при build) |
| `outputs/oss-assistant-deck/output.pptx` | Основен export |
| `outputs/oss-assistant-deck/narrative_plan.md` | Стар narrative plan (може да е остарял спрямо build.mjs) |
| `docs/PRESENTATION_2026-07-08.md` | Съдържателни бележки за активна разработка (не дизайн) |
...
```powershell
& "$HOME\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe" `
  "C:\Users\a1bg514837\Downloads\oss-assistant\tmp\slides\oss-assistant\build\build.mjs"
```
...
- Нов hero фон → сложи в `tmp/slides/pro-reference-images/` и викни `await plate(s, "slide-XX.png")`.
...
Контекст: docs/OSS_ASSISTANT_DECK_HANDOFF.md
Файл: tmp/slides/oss-assistant/build/build.mjs
...
- Builder: `tmp/slides/oss-assistant/build/build.mjs`
- Primary output: `outputs/oss-assistant-deck/output.pptx`
